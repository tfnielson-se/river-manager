...
const AdminMenu = ({ currentUser }) => {
	...
	return (
		<>
			...
			<NavLink to="/employees/list" className="text-gray-800 transition-colors duration-300 transform dark:text-gray-200 border-b-2 border-blue-500 mx-1.5 sm:mx-6">Employees List</NavLink>
		</>
	);
};
