const Home = () => {
	return (
		<section class="container px-4 mx-auto mt-5">
				...
				<div class="text-center">
					<p class="font-medium text-blue-500 dark:text-blue-400">
						Welcome to River Manager
					</p>

					<h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white italic">
                    "People change | Rivers Change | River People Never Change"
					</h1>
				...
				<div class="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
					...
					<div class="flex flex-col items-center justify-center text-center">
						...
						<span class="mt-2 text-blue-500 dark:text-blue-400">
							Denver, CO 🇺🇸
						</span>
                        <span class="mt-2 text-blue-500 dark:text-blue-400">
                            Penha, SC 🇧🇷
		...
		// <div>
		//     <h2>Welcome to River Manager</h2>
		//     <h3> /h3>
		// </div>
	);
};
